...
class RoleDescriptor{
	...
	public function add_key_descriptor(KeyDescriptor $key_descriptor)
	{
	...
	public function add_organisation(Organization $organization){
 	...
 	public function add_contact_person(Contact_persons $contact_person){
