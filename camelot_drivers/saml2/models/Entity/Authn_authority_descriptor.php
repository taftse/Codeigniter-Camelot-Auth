...
class Authn_authority_descriptor extends Role_descriptor{

	public array $authn_query_service;
	...
	public function add_authn_query_service($binding,$location,$response_location = NULL)
	{
		$this->authn_query_service[] = new Endpoint_type($binding,$location,$response_location);
	}
