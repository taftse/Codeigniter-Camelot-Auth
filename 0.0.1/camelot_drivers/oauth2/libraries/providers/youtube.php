 ...
 */
class Oauth2_Provider_Youtube extends Oauth2_provider
{
	...
	{
		$scope = array('https://www.google.com/m8/feeds','http://gdata.youtube.com');
		/*foreach ($this->CI->config->item('Youtube_Permissions') as $premission => $value) {
			if($value === TRUE){
